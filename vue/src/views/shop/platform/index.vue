...
<!--      <el-table-column type="selection" width="55" align="center" />-->
      ...
      <el-table-column :label="$t('shop.platform')" align="center" prop="name" />
...
<!--       <el-table-column label="回调URL" align="center" prop="redirectUri" />-->
      <el-table-column :label="$t('shop.serverUrl')" align="center" prop="serverUrl" />
      <el-table-column :label="$t('list.status')" align="center" width="100">
...
<!--          >省市区地址库</el-button>-->
    ...
    <!-- 添加或修改店铺对话框 -->
    <el-dialog title="Edit" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        <el-form-item :label="$t('shop.platform')" prop="name">
          <el-input v-model="form.name" disabled :placeholder="$t('shop.platform')" />
        </el-form-item>
        <el-form-item label="Code" prop="code">
          <el-input v-model="form.code" disabled placeholder="Code" />
        </el-form-item>
        <el-form-item label="AppKey" prop="appKey">
          <el-input v-model="form.appKey" placeholder="AppKey" />
        </el-form-item>
        <el-form-item label="AppSecret" prop="appSecret">
          <el-input v-model="form.appSecret" placeholder="AppSecret" />
        </el-form-item>
        <el-form-item label="Redirect URL" prop="redirectUri">
          <el-input v-model="form.redirectUri" placeholder="Redirect URL" />
        </el-form-item>
        <el-form-item :label="$t('shop.serverUrl')" prop="serverUrl">
          <el-input v-model="form.serverUrl" :placeholder="$t('shop.serverUrl')" />
        </el-form-item>
