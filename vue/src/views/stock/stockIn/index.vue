...
<!--          <el-table-column type="selection" width="50" align="center" />-->
          ...
          <el-table-column label="入库仓位编码" prop="positionId" width="150">
            <template slot-scope="scope">
              <el-select v-model="scope.row.positionId" filterable remote reserve-keyword placeholder="仓位编码"
...
<script>
import { listStockIn, getWmsStockInEntry, stockIn ,complete} from "@/api/stock/stockIn";
import { listWarehouse,searchPosition } from "@/api/stock/warehouse";
