<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="86px">
      ...
      <el-form-item :label="$t('list.code')" prop="number">
        <el-input
...
<!--      </el-col>-->
    ...
    <el-table v-loading="loading" :data="supplierList" @selection-change="handleSelectionChange">
      ...
      <el-table-column :label="$t('list.name')" align="center" prop="name" />
...
<!--      </el-table-column>-->
      ...
      <el-table-column :label="$t('list.man')" align="center" prop="linkman" />
      <el-table-column :label="$t('list.phone')" align="center" prop="contact" />
