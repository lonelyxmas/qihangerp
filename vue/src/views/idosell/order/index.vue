<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="128px">
      <el-form-item :label="$t('order.orderNum')" prop="orderSerialNumber">
        <el-input
          v-model="queryParams.orderSerialNumber"
    ...
    <el-table v-loading="loading" :data="orderList" @selection-change="handleSelectionChange">
      ...
      <el-table-column :label="$t('order.orderNum')" align="left" prop="orderSerialNumber" width="220px">
        <template slot-scope="scope">
          ...
          > {{scope.row.orderSerialNumber}}</el-button>
...
<script>
import {listOrder, pullOrder, getOrder, pushOms, pullOrderDetail} from "@/api/idosell/order";
