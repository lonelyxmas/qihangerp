...
//        queryWrapper.eq(bo.getOuterErpGoodsId()!=null,OGoodsSku::getOuterErpGoodsId,bo.getOuterErpGoodsId());
        ...
        queryWrapper.eq(StringUtils.hasText(bo.getGoodsNum()),OGoodsSku::getGoodsNum,bo.getGoodsNum());
...
//                        spec.setColorImage(images[0]);
//                    }else {
//                        spec.setColorImage(image);
//                    }
//                }
//            }
...
//            inventory.setGoodsId(goods.getId().toString());
...
//                specAttr.setGoodsId(goods.getId().toString());
