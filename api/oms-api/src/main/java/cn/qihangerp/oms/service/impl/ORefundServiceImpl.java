...
import cn.qihangerp.oms.service.ORefundService;
...
//            typeOr.or().eq(ORefund::getRefundType,20);
    ...
    public ResultVo<Long> refundProcessing(RefundProcessingBo processingBo, String createBy) {
        ...
        afterSale.setOOrderId(oOrders.isEmpty()?0L:oOrders.get(0).getId());
        afterSale.setOOrderItemId(oOrderItems.isEmpty()?0L:oOrderItems.get(0).getId());
