...
@AllArgsConstructor
@RestController
@RequestMapping("/api/oms-api/stockIn")
public class StockInController extends BaseController {
    private final OGoodsStockInService stockInService;
    @GetMapping("/list")
    public TableDataInfo list(OGoodsStockIn bo, PageQuery pageQuery)
    {
    ...
    {
        OGoodsStockIn entry = stockInService.getDetailAndItemById(id);
